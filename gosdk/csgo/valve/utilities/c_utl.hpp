...
template <class T> inline T * Construct( T * pMemory ) { return ::new ( pMemory ) T; }

template <class T> inline void Destruct( T * pMemory ) { pMemory->~T( ); }
...
public:
  ...
  int AddToTail( ) { return InsertBefore( m_Size ); }
